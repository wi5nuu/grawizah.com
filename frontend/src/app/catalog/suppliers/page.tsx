...
export default function SupplierDirectoryPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#fafafa] dark:bg-dark-background text-on-surface dark:text-dark-on-surface font-body">
      <DashboardSidebar
        collapsed={collapsed}
      ...
      >
        ...
        <main className="p-8 max-w-6xl mx-auto">
          ...
          <nav className="flex items-center text-[13px] text-gray-500 dark:text-gray-400 mb-6 font-medium">
            <Link href="/catalog" className="hover:text-[#5300b7] dark:hover:text-[#d0bcff] transition-colors">Catalog</Link>
            <span className="material-symbols-outlined text-[14px] mx-1">chevron_right</span>
            <span className="text-[#5300b7] dark:text-[#d0bcff] font-bold">Suppliers</span>
          </nav>
