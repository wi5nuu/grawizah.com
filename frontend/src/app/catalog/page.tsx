      ...
      <header className="border-b border-gray-200 bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="/catalog" className="text-primary-700 font-semibold transition">
              Catalog
            </a>
            <a href="/features" className="text-gray-700 hover:text-primary-700 transition">
              Features
            </a>
            <a href="/pricing" className="text-gray-700 hover:text-primary-700 transition">
              Pricing
            </a>
          </nav>
          <div className="flex items-center space-x-4">
            <a href="/login" className="text-gray-700 hover:text-primary-700 transition">
              Login
            </a>
